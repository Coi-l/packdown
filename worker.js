...
self.importScripts('./packdown.js');
...
function parse(e, version) {
  if (version == './marked.js') {
    marked.registerBlockExtension(packdown.markedExtension);
  }
  switch (e.data.task) {
    case 'defaults':
